...
pub fn jvm_signature_string(jvm_type: &JvmType) -> String {
    match *jvm_type {
        ...
        JvmType::Array(ref jvm_array_type) => format!("[{}", jvm_signature_string(&jvm_array_type)),
    }
}
...
pub fn jvm_method_signature_string(
    ...
    let return_type_signature: String =
        jvm_method_return_type.map_or(String::from(""), |t| jvm_signature_string(&t));
